...
from models import Actor, Movie, Stuntman, ContactDetails
...
bourne_identity.actors_new = [matt_damon]
furious_7.actors_new = [dwayne_johnson]
pain_and_gain.actors_new = [dwayne_johnson, mark_wahlberg]
